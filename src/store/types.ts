...
export interface Store {
  ...
  /** `unsubscribed` → `subscribed`, clearing `unsubscribedAt`. Never touches `tokenVersion`. */
  resubscribe(id: string): Promise<SubscriberRow>;
  /** Sets the status and its matching timestamp. Never touches `tokenVersion`. */
